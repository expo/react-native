    ...
    },
    {
      ...
      render: (): React.Node => (
        <DemoContent>
          <CodeBlock
            code={
              '// DOM-CSS-LIMITATION(list-style-type-subset)\n' +
              '@counter-style and the rest of the predefined styles\n' +
              '(cjk-*, hebrew, georgian, …) are not modelled; an\n' +
              'unknown keyword falls back rather than breaking.\n\n' +
