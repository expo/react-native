...
:root {
  --surface-raised: rgb(242, 244, 247);
  --ink: rgb(16, 24, 40);
  --radius: 10px;
}
.dark { --surface-raised: rgb(30, 34, 45); --ink: rgb(242, 242, 247); }
...
<div className="card">
  ...
  min-height: var(--touch);   /* 44px — the iOS HIG minimum */
  padding: 0 18px;
...
.btn[data-variant='outline'] {
  ...
  border: 1px solid var(--accent);   /* shorthand → RN longhands */
  color: var(--accent);
}
