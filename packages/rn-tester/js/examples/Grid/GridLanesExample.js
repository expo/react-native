  ...
  return (
    <View
      style={{
        ...
        // Padding on the block axis is asymmetric on purpose. The heights are
        // what these demos are about — flow-tolerance has something to decide
        // only because the tiles differ — so the shortest of them, 20, is not
        // negotiable, and 6pt above and below left 8 for a line of text that
        // wants 13. The label clipped. Padding gives way instead.
        paddingHorizontal: 6,
        paddingBottom: 4,
      }}>
