...
export function Svg(props: {
  ...
  const width = resolveLength(props.width, fontSize, fontSize);
  const height = resolveLength(props.height, fontSize, fontSize);
  ...
  const currentColor = props.color ?? inherited.currentColor;
