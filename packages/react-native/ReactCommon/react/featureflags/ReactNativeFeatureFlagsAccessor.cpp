 ...
 *
 * @generated SignedSource<<da81824021f7c42e4090791479b763af>>
 */
...
bool ReactNativeFeatureFlagsAccessor::enableNativeGestureRecognizers() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(39, "enableNativeGestureRecognizers");
...
bool ReactNativeFeatureFlagsAccessor::enableStringChildren() {
  auto flagValue = enableStringChildren_.load();
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(44, "enableStringChildren");
...
bool ReactNativeFeatureFlagsAccessor::enableYogaDisplayBlock() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(53, "enableYogaDisplayBlock");
