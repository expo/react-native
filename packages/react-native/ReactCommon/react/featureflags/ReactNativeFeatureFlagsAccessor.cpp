 ...
 *
 * @generated SignedSource<<4e1cdfdb12e91f3a3401576d9922d812>>
 */
...
bool ReactNativeFeatureFlagsAccessor::enableImplicitTextChildren() {
  auto flagValue = enableImplicitTextChildren_.load();
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(28, "enableImplicitTextChildren");

    flagValue = currentProvider_->enableImplicitTextChildren();
    enableImplicitTextChildren_ = flagValue;
  }

  return flagValue.value();
}

bool ReactNativeFeatureFlagsAccessor::enableYogaDisplayBlock() {
  auto flagValue = enableYogaDisplayBlock_.load();
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(29, "enableYogaDisplayBlock");
