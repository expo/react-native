...
jsi::Value ExpoScrollEvent::asJSIValue(jsi::Runtime& runtime) const {
  ...
  {
    auto shift = jsi::Object(runtime);
    shift.setProperty(runtime, "x", contentShift.x);
    shift.setProperty(runtime, "y", contentShift.y);
    payload.setProperty(runtime, "contentShift", shift);
  }
...
folly::dynamic ExpoScrollEvent::asDynamic() const {
  return folly::dynamic::object(
      ...
      "contentShift", folly::dynamic::object("x", contentShift.x)("y", contentShift.y))(
