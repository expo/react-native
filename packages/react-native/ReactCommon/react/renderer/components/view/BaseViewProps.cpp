...
BaseViewProps::BaseViewProps(
    ...
    : YogaStylableProps(context, sourceProps, rawProps, filterObjectKeys),
      ...
      animationKeyframesRaw(convertRawProp(
          context,
          rawProps,
          "animationKeyframes",
          sourceProps.animationKeyframesRaw,
          {})),
      animationDurationRaw(convertRawProp(
          context,
          rawProps,
          "animationDuration",
          sourceProps.animationDurationRaw,
          {})),
      animationDelayRaw(convertRawProp(
          context,
          rawProps,
          "animationDelay",
          sourceProps.animationDelayRaw,
          {})),
      animationTimingFunctionRaw(convertRawProp(
          context,
          rawProps,
          "animationTimingFunction",
          sourceProps.animationTimingFunctionRaw,
          {})),
      animationIterationCountRaw(convertRawProp(
          context,
          rawProps,
          "animationIterationCount",
          sourceProps.animationIterationCountRaw,
          {})),
      animationDirectionRaw(convertRawProp(
          context,
          rawProps,
          "animationDirection",
          sourceProps.animationDirectionRaw,
          {})),
      animationFillModeRaw(convertRawProp(
          context,
          rawProps,
          "animationFillMode",
          sourceProps.animationFillModeRaw,
          {})),
      animation(buildAnimation(
          animationKeyframesRaw,
          animationDurationRaw,
          animationDelayRaw,
          animationTimingFunctionRaw,
          animationIterationCountRaw,
          animationDirectionRaw,
          animationFillModeRaw)),
