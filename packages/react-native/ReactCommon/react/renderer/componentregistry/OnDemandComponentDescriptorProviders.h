 ...
 *
 * This is the timing-safe seam for components a provider supplies from outside react-native (e.g. the
 * expo-intrinsics DOM elements). A library registers its providers here at load; react-native's
 ...
 * wiring, and react-native names no specific component.
 */
