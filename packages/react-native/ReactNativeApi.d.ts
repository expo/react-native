 ...
 *
 * @generated SignedSource<<eb38dd92a311caf5624c07b620939a0b>>
 *
...
>
declare type ____InheritableTextStyle_Internal = {
  readonly all?: "inherit" | "initial" | "revert" | "unset"
  readonly color?: ____ColorValue_Internal
  readonly fontFamily?: string
  readonly fontSize?: number
  readonly fontSizeEm?: number
...
declare type ____LayoutStyle_Internal = {
  ...
  readonly clear?:
    "both" | "inline-end" | "inline-start" | "left" | "none" | "right"
  ...
  readonly float?: "inline-end" | "inline-start" | "left" | "none" | "right"
  readonly flowTolerance?: number | string
  readonly gap?: number | string
  readonly gridArea?: string
  readonly gridAutoColumns?: number | string
  readonly gridAutoFlow?: "column dense" | "column" | "row dense" | "row"
  readonly gridAutoRows?: number | string
  readonly gridColumnEnd?: number | string
  readonly gridColumnStart?: number | string
  readonly gridRowEnd?: number | string
  readonly gridRowStart?: number | string
  readonly gridTemplateAreas?: string
  readonly gridTemplateColumns?: number | string
  readonly gridTemplateRows?: number | string
...
declare type ____ViewStyle_InternalBase = {
  ...
  readonly animationDuration?: number | string
  readonly animationFillMode?: "backwards" | "both" | "forwards" | "none"
  readonly animationIterationCount?: number | string
  readonly animationKeyframes?: string
  ...
  readonly transitionDelay?: number | string
  readonly transitionDuration?: number | string
  readonly transitionProperty?: string
  readonly transitionTimingFunction?: string
  readonly uaFontSizeEm?: number
  readonly uaFontWeight?: ____FontWeight_Internal
  readonly uaMarginBlockEm?: number
  readonly uaMarginBlockRem?: number
  readonly whiteSpace?:
    "break-spaces" | "normal" | "nowrap" | "pre-line" | "pre-wrap" | "pre"
}
declare type ____ViewStyle_InternalCore = Readonly<
  ____InheritableTextStyle_Internal &
...
declare type PartialViewConfig = {
  ...
  readonly recordNodeName?: ViewConfig["recordNodeName"]
  readonly resolveUIViewClassName?: ViewConfig["resolveUIViewClassName"]
  readonly supportsRawText?: boolean
  readonly uaStyle?: ViewConfig["uaStyle"]
...
declare type ViewConfig = {
  ...
  readonly recordNodeName?: boolean
  readonly resolveUIViewClassName?: (props: {
    [$$Key$$: string]: unknown
  }) => string
  readonly supportsRawText?: boolean
  readonly uaStyle?:
...
export {
  ...
  ActivityIndicator, // 12d50b56
  ActivityIndicatorInstance, // a82dd4e7
  ActivityIndicatorProps, // c167d708
  Alert, // a398a509
  ...
  DrawerLayoutAndroid, // b74ff1f8
  DrawerLayoutAndroidInstance, // c0694352
  DrawerLayoutAndroidProps, // fd604ce3
  ...
  FlatList, // e15c4ad1
  FlatListInstance, // 0cba4dfe
  FlatListProps, // 5e0b4f8e
  FocusEvent, // 850f1517
  ...
  Image, // 57ad2c7d
  ImageBackground, // 2b6ee53c
  ImageBackgroundInstance, // 9eab32a1
  ImageBackgroundProps, // 6bbb0888
  ...
  InputAccessoryView, // 56cde457
  InputAccessoryViewProps, // 6235f6a7
  ...
  KeyUpEvent, // 57f832c5
  Keyboard, // 49414c97
  KeyboardAvoidingView, // eb9f8399
  KeyboardAvoidingViewInstance, // 38adf824
  KeyboardAvoidingViewProps, // 91c682bd
  ...
  NativeComponentRegistry, // e1015870
  ...
  RefreshControl, // 02895bee
  RefreshControlInstance, // ae61fd05
  RefreshControlProps, // 18983d0f
  ...
  RootViewStyleProvider, // c1894570
  Runnable, // 594dd93a
  Runnables, // 4367c557
  SafeAreaView, // acfb1ab6
  SafeAreaViewInstance, // 21dba39c
  ScaledSize, // 07e417c7
  ScrollEvent, // d7abdd0a
  ScrollResponderType, // 9ac8f4ff
  ScrollToLocationParamsType, // d7ecdad1
  ScrollView, // c7007d30
  ScrollViewImperativeMethods, // b5abcc2f
  ScrollViewInstance, // 6c232d26
  ScrollViewProps, // 3623b463
  ScrollViewPropsAndroid, // 02f3df2e
  ScrollViewPropsIOS, // 807cb4f6
  ScrollViewScrollToOptions, // 3313411e
  SectionBase, // 9f13db00
  SectionList, // 24965d3e
  SectionListData, // 1a4de01a
  SectionListInstance, // 2c9e6a6b
  SectionListProps, // 951857f5
  ...
  TouchableHighlight, // 5338bbd3
  TouchableHighlightInstance, // b510c0eb
  TouchableHighlightProps, // dc7b9620
  TouchableNativeFeedback, // 6cd2b9e1
  TouchableNativeFeedbackInstance, // 2a984649
  TouchableNativeFeedbackProps, // 1b528492
  TouchableOpacity, // 47c9ed13
  TouchableOpacityInstance, // b186055b
  TouchableOpacityProps, // a4f3061a
  TouchableWithoutFeedback, // a1bf5a9d
  TouchableWithoutFeedbackProps, // 2eac06ba
