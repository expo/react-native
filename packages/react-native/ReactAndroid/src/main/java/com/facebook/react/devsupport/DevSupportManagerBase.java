...
public abstract class DevSupportManagerBase implements DevSupportManager {
   ...
   */
    ...
    public void showDevOptionsDialog() {
        ...
        if (mDevSettings.isDeviceDebugEnabled() && !mDevSettings.isRemoteJSDebugEnabled()) {
            ...
            String debuggerItemString = mApplicationContext.getString(isConnected ? R.string.reactandroid_catalyst_debug_open : R.string.reactandroid_catalyst_debug_open_disabled);
            if (!isConnected) {
        ...
        options.put(mDevSettings.isHotModuleReplacementEnabled() ? mApplicationContext.getString(R.string.reactandroid_catalyst_hot_reloading_stop) : mApplicationContext.getString(R.string.reactandroid_catalyst_hot_reloading), () -> {
        ...
        options.put(mDevSettings.isFpsDebugEnabled() ? mApplicationContext.getString(R.string.reactandroid_catalyst_perf_monitor_stop) : mApplicationContext.getString(R.string.reactandroid_catalyst_perf_monitor), () -> {
        ...
        if (jsExecutorDescription != null) {
            ...
            jsExecutorLabel.setText(context.getString(R.string.reactandroid_catalyst_dev_menu_sub_header, jsExecutorDescription));
   ...
   */
    ...
    public void openDebugger() {
        mDevServerHelper.openDebugger(mCurrentContext, mApplicationContext.getString(R.string.reactandroid_catalyst_open_debugger_error));
    }
