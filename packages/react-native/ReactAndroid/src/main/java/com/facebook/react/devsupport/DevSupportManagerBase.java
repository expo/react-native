...
public abstract class DevSupportManagerBase implements DevSupportManager {
   ...
   */
    ...
    public void updateJSError(final String message, final ReadableArray details, final int errorCookie) {
        UiThreadUtil.runOnUiThread(() -> {
            ...
            if ((mRedBoxSurfaceDelegate != null && !mRedBoxSurfaceDelegate.isShowing()) || errorCookie != mLastErrorCookie) {
                return;
            }
    ...
    private void resetCurrentContext(@Nullable ReactContext reactContext) {
        ...
        if (mCurrentContext != null) {
            try {
                ...
                mCurrentContext.getJSModule(HMRClient.class).setup("android", path, host, port, mDevSettings.isHotModuleReplacementEnabled(), scheme);
   ...
   */
    ...
    public void openDebugger() {
        mDevServerHelper.openDebugger(mCurrentContext, mApplicationContext.getString(R.string.catalyst_open_debugger_error));
    }
