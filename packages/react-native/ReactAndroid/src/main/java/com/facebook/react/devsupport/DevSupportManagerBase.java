...
public abstract class DevSupportManagerBase implements DevSupportManager {
    ...
    public DevSupportManagerBase(Context applicationContext, ReactInstanceDevHelper reactInstanceDevHelper, @Nullable String packagerPathForJSBundleName, boolean enableOnCreate, @Nullable RedBoxHandler redBoxHandler, @Nullable DevBundleDownloadListener devBundleDownloadListener, int minNumShakes, @Nullable Map<String, RequestHandler> customPackagerCommandHandlers, @Nullable SurfaceDelegateFactory surfaceDelegateFactory, @Nullable DevLoadingViewManager devLoadingViewManager) {
        ...
        mDevServerHelper = new DevServerHelper(mDevSettings, mApplicationContext.getPackageName(), mDevSettings.getPackagerConnectionSettings());
   ...
   */
    ...
    public void showDevOptionsDialog() {
        ...
        if (mDevSettings.isDeviceDebugEnabled() && !mDevSettings.isRemoteJSDebugEnabled()) {
            ...
            options.put(mApplicationContext.getString(R.string.reactandroid_catalyst_debug_open), () -> mDevServerHelper.openDebugger(mCurrentContext, mApplicationContext.getString(R.string.reactandroid_catalyst_open_debugger_error)));
        }
   ...
   */
    ...
    public void reloadJSFromServer(final String bundleURL) {
        reloadJSFromServer(bundleURL, () -> UiThreadUtil.runOnUiThread(mReactInstanceDevHelper::onJSBundleLoadedFromServer));
    }
