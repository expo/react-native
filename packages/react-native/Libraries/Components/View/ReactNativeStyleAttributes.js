...
const ReactNativeStyleAttributes: {[string]: AnyAttributeType, ...} = {
  ...
  direction: true,
  display: true,
  // CSS Grid (css-grid-2). Track lists are CSS strings, e.g.
  ...
  justifyItems: true,
  justifySelf: true,
  // css-lists-3 §3. Carried natively because list markers are generated by the
  // list container in C++, which is the only place an item's position among
  // its siblings is known.
  listStyleType: true,
