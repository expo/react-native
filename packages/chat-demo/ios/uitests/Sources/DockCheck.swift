...
final class DockCheck: DemoCase {
  ...
  ///
  /// The trailing margin is the LEADING one, and it has to be: the platform's
  /// pill ends on the same line its sent balloons rest at — measured off a clip
  /// of it on a 393-point window, the pill at 376.7 and the balloon at 376.7 —
  /// so a balloon born over the field shares that edge and keeps it for the
  /// whole send.
