 ...
 */
export const RECEIPT_SWAP_AT_MS: number = RECEIPT_SWAP_OUT_MS + RECEIPT_SWAP_GAP_MS;
 ...
 */
export const RECEIPT_SETTLED_MS: number = RECEIPT_INK_DELAY_MS + RECEIPT_FADE_MS;
export const RECEIPT_HOLD_MS: number = 400;
